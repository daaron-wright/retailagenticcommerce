...
export default function Chapter1Panel() {
  return (
    <div className="bg-white relative size-full" data-name="Chapter 1- Panel 09">
      <div className="absolute left-0 size-[1194px] top-[-260px]" data-name="1000009751">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src="53a5dc964216f7a72ccf20d31c2a63994d2ab7b1.png" />
      </div>
      <div className="absolute bg-[rgba(0,0,0,0.55)] h-[834px] left-0 top-0 w-[1194px]" />
      <div className="absolute font-['TWK_Everett:Regular',sans-serif] leading-[0] left-[47px] not-italic text-[20px] text-white top-[calc(50%-100px)] tracking-[0.064px] w-[485px] whitespace-pre-wrap">
        <p className="leading-[28px] mb-0">{`Emily decides to extend her business trip and instead make it a "bleisure" trip, blending business with leisure to explore the city's culture with her husband Marcus. `}</p>
        <p className="leading-[28px] mb-0">&nbsp;</p>
        <p className="leading-[28px]">{`As a CMO, Emily expects top-notch customer experiences. `}</p>
      </div>
      <div className="absolute h-[50px] left-[47px] top-[48px] w-[156.198px]" data-name="kyndryl ®">
        <Artwork />
      </div>
      <div className="absolute h-[49px] left-[47px] top-[533px] w-[40px]" data-name="Tooltip-animated">
      ...
      <div className="absolute h-[422px] right-[80px] top-[138px] w-[450px]" data-name="Chat" />
      <MaskGroup />
