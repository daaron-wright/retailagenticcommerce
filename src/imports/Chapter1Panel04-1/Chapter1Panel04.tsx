...
function Frame() {
  return (
    <div className="absolute h-[103px] right-[48px] top-[48px] w-[605px]">
      <Group5 />
      <Row />
    </div>
  );
...
export default function Chapter1Panel() {
  return (
    <div className="bg-white relative size-full" data-name="Chapter 1- Panel 04">
