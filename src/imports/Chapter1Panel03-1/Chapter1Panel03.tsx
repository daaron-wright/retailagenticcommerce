import svgPaths from "./svg-7teonivewh";
import imgMariausbeckAMixedRaceWomanAround35YearsOld1 from "./b7a24300d885d2e81585d9063aae2e45c4b1b05d.png";
import { imgMariausbeckAMixedRaceWomanAround35YearsOld } from "./svg-hpvym";

function MaskGroup() {
  return <div className="absolute contents left-[47px] size-[460px] top-[187px]" data-name="Mask group" />;
}
...
function MaskGroup1() {
  return (
    <div className="absolute contents left-[47px] size-[460px] top-[187px]" data-name="Mask group">
      <div className="absolute left-[42.78px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[4.221px_0px] mask-size-[460px_460px] size-[480.046px] top-[187px]" data-name="mariausbeck_a_mixed_race_woman_around_35_years_old" style={{ maskImage: `url('${imgMariausbeckAMixedRaceWomanAround35YearsOld}')` }}>
...
function Group5() {
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute bg-gradient-to-b from-white h-[103px] left-0 rounded-[20px] shadow-[0px_0px_10px_10px_rgba(0,0,0,0.07)] to-[#f2f1ee] top-0 w-[605px]" />
    </div>
  );
}
  ...
  return (
    <div className="col-1 h-[42px] ml-0 mt-[11.25px] relative row-1 w-[40px]" data-name="Wsk9iN">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 42.0002">
        <g id="Wsk9iN">
          <path d={svgPaths.p26082b00} fill="url(#paint0_linear_2_1256)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_1256" x1="20" x2="20" y1="0" y2="42.0002">
...
function Row() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[20px] h-[68px] items-center left-[20px] top-[calc(50%-0.5px)]" data-name="Row">
      <Group4 />
...
function Frame() {
  return (
    <div className="absolute h-[103px] right-[48px] top-[-112px] w-[605px]">
      <Group5 />
      <Row />
    </div>
  );
...
export default function Chapter1Panel() {
  return (
    <div className="bg-white relative size-full" data-name="Chapter 1- Panel 03">
      ...
      <MaskGroup1 />
      <Frame />
      <p className="absolute font-['TWK_Everett:Regular',sans-serif] leading-[28px] left-[calc(68.75%-208.88px)] not-italic text-[20px] text-white top-[calc(50%-64px)] tracking-[0.064px] w-[485px] whitespace-pre-wrap">
        {`Heading to Paris for an industry conference, `}
        <br aria-hidden="true" />
        {`Emily receives a notification from her airline `}
        <br aria-hidden="true" />
        that a low-fare seat is available on her flight.
      </p>
