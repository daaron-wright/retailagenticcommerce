import svgPaths from "./svg-a07mk7khhz";
...
function InsulinOrder() {
  return (
    <div className="absolute contents left-[calc(37.5%+8.75px)] top-[526.37px]" data-name="insulin order">
      ...
      <p className="absolute font-['TWK_Everett:Medium',sans-serif] h-[49px] leading-[44px] left-[calc(50%+29px)] not-italic text-[#f6f7f9] text-[24px] top-[943px] w-[52px]">Yes</p>
      <div className="-translate-x-1/2 absolute font-['TWK_Everett:Bold',sans-serif] h-[148.957px] leading-[0] left-[calc(37.5%+294.25px)] not-italic text-[32px] text-black text-center top-[720.37px] w-[473.185px] whitespace-pre-wrap">
        <p className="leading-[45px] mb-0">{`Would you like to renew `}</p>
        <p className="leading-[45px] mb-0">{`your insulin prescription with `}</p>
        <p className="leading-[45px] mb-0">{`Harvest Pharmacy now `}</p>
        <p className="leading-[45px]">and add to your order?</p>
      </div>
...
export default function Insulin() {
  return (
    <div className="border border-black border-solid relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="insulin">
      <InsulinOrder />
      <div className="absolute bg-[rgba(217,217,217,0)] h-[66px] left-[calc(37.5%+35.75px)] top-[928px] w-[495px]" />
    </div>
  );
}